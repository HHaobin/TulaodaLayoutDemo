...
public class Cart2_F extends Fragment implements OnClickListener {
	...
	private ImageView cart_iv_refresh;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.cart2_f, null);
		initView(view);
		return view;
	}
	...
	private void initView(View view) {
		...
		cart_iv_refresh= (ImageView) view.findViewById(R.id.cart_iv_refresh);
		...
		cart_iv_refresh.setOnClickListener(this);
