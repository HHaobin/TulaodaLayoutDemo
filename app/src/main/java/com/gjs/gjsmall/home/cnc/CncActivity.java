...
public class CncActivity extends Activity implements View.OnClickListener{
    //private TextView textview;
    private ImageView iv_cnc_opinion_back;
    private TextView explain_cnc_top_title;
    private WebView webview;  
    private String path="http://gjs.wsh68.com/wap/";
    ...
    private void init(){
        ...
        //判断是否有网络
        if (isNetworkAvailable(CncActivity.this))
        {
