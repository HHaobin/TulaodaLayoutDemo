 ...
 *
 */
public class Point_one2_F
		extends Fragment
		implements View.OnTouchListener, XListView.IXListViewListener, OnClickListener{
	...
	String url;
	String aaa;
	private TextView       RelativeLayout_ware_text,RelativeLayout_ware_text2,RelativeLayout_ware_text3,RelativeLayout_ware_text4,RelativeLayout_ware_text5,RelativeLayout_ware_text6;
	...
	private void initView(View view) {
		...
		ll_search = (LinearLayout)view.findViewById(R.id.ll_choice);
		ed_search = (EditText) view.findViewById(R.id.ed_Searchware);
		iv_back = (ImageView) view.findViewById(R.id.iv_back);

		RelativeLayout_ware         = (RelativeLayout) view.findViewById(R.id.RelativeLayout_ware);
		RelativeLayout_ware_text    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text);
		RelativeLayout_ware_text2    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text2);
		RelativeLayout_ware_text3    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text3);
		RelativeLayout_ware_text4    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text4);
		RelativeLayout_ware_text5    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text5);
		RelativeLayout_ware_text6    = (TextView) view.findViewById(R.id.RelativeLayout_ware_text6);


		RelativeLayout_ware_text2.setOnClickListener(this);
		RelativeLayout_ware_text3.setOnClickListener(this);
		RelativeLayout_ware_text4.setOnClickListener(this);
		RelativeLayout_ware_text5.setOnClickListener(this);
		RelativeLayout_ware_text6.setOnClickListener(this);
		...
		listView.setOnTouchListener(Point_one2_F.this);
	...
	public void onClick(View v) {
		switch (v.getId()){
			case R.id.RelativeLayout_ware_text2:
				...
				break;
			case R.id.RelativeLayout_ware_text3:
				mSearch ="台灯";
				//请求网络数据
				new WareTask().execute();
				//onRefresh();
				ed_search.setText("台灯");
				break;
			case R.id.RelativeLayout_ware_text4:
				mSearch ="手提包";
				//请求网络数据
				new WareTask().execute();
				//onRefresh();
				ed_search.setText("手提包");
				break;
			case R.id.RelativeLayout_ware_text5:
				mSearch ="零食";
				//请求网络数据
				new WareTask().execute();
				//onRefresh();
				ed_search.setText("零食");
				break;
			case R.id.RelativeLayout_ware_text6:
				mSearch ="家电";
				//请求网络数据
				new WareTask().execute();
				//onRefresh();
				ed_search.setText("家电");
				break;
			default:
				break;
		}
			...
			if (result != null && result.get("data") != null) {
				...
				listView.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
						...
						//
						Intent intent1=new Intent(getActivity(), BabyActivity.class);
						//用Bundle携带数据
						bundle=new Bundle();
						//传递name参数为tinyphp
